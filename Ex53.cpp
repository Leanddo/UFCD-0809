...
using namespace std;
/*
Faz um programa que receba o total das vendas de cada vendedor e guarde em um vetor.
Receba também a percentagem da comissão de cada vendedor e armazene em outro vetor.
...
int main()
{
    ...
    cout << "Eis os nomes dos vendadores e o quanto devem receber: \n";
